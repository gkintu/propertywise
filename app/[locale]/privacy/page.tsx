...
import ShakeMotion, { ShakeMotionHandle } from "@/components/motion/ShakeMotion";
...
export default function PrivacyPolicy({ params }: PrivacyPageProps) {
  ...
  // Use a lower intensity for a more subtle shake
  const subtleShakeIntensity = 0.5; // very subtle, but slightly more visible
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#fffef2] to-white dark:from-[#111827] dark:to-[#1F2937]">
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <SlideIn direction="up" delay={0.2}>
            <div className="mb-8">
              <ShakeMotion className="inline-block" ref={shakeRef} intensity={subtleShakeIntensity} duration={400}>
                <Link
                  href={`/${locale}`}
                  className="inline-flex items-center text-yellow-700 dark:text-[#FBBF24] hover:text-yellow-800 dark:hover:text-[#f6c40c] mb-4"
                  onMouseEnter={() => {
              ...
              <h1 className="text-4xl font-bold text-gray-900 dark:text-[#F9FAFB] mb-4">
                {t("title")}
              </h1>
              <p className="text-lg text-gray-600 dark:text-[#D1D5DB]">
                {t("lastUpdated")}:{" "}
              ...
              <Card className="mb-8 dark:bg-[#1F2937] dark:border-[#374151]">
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div>
                      <h3 className="font-semibold text-lg mb-3 dark:text-[#F9FAFB]">
                        {t("dataCollection.documentData.title")}
                      </h3>
                      <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-[#D1D5DB]">
                        ...
                        <li>
                          {t("dataCollection.documentData.analysisResults")}
                        </li>
                        <li>
                          {t("dataCollection.documentData.temporaryProcessing")}
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      <h3 className="font-semibold text-lg mb-3 dark:text-[#F9FAFB]">
                        {t("dataCollection.preferences.title")}
                      </h3>
                      <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-[#D1D5DB]">
                    ...
                    <div className="mt-6">
                      <p className="text-gray-700 dark:text-[#D1D5DB] leading-relaxed">
                        <span className="font-medium">
                          {t("dataCollection.notice.title")}:
                        </span>{" "}
                        {t("dataCollection.notice.description")}
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="mb-8 dark:bg-[#1F2937] dark:border-[#374151]">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <p className="text-gray-700 dark:text-[#D1D5DB] mb-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-[#374151] rounded-lg">
                        <span className="font-medium dark:text-[#F9FAFB]">
                          {t("dataRetention.documentData")}
                        </span>
                        <span className="text-yellow-700 dark:text-[#FBBF24]">
                          {t("dataRetention.documentDataPeriod")}
                        </span>
                      </div>

                      <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-[#374151] rounded-lg">
                        <span className="font-medium dark:text-[#F9FAFB]">
                          {t("dataRetention.localStorage")}
                        </span>
                        <span className="text-yellow-700 dark:text-[#FBBF24]">
                          {t("dataRetention.localStoragePeriod")}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="mb-8 dark:bg-[#1F2937] dark:border-[#374151]">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-semibold dark:text-[#F9FAFB]">
                    ...
                    <p className="text-sm text-gray-600 dark:text-[#D1D5DB] mt-4">
            ...
            <CardMotion delay={0.4}>
              <Card className="mb-8 dark:bg-[#1F2937] dark:border-[#374151]">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-700 dark:text-[#D1D5DB]">
          ...
          <SlideIn direction="up" delay={0.8}>
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <Button
                variant="outline"
                asChild
                className="flex-1 dark:border-[#374151] dark:text-[#F9FAFB] dark:hover:bg-[#374151]"
              >
                <Link href={`/${locale}`}>
                  <ArrowLeft className="h-4 w-4 mr-2" />
